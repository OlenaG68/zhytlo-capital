                ...
                <div className="flex flex-col gap-4 px-3 md:px-0 max-w-[666px] relative z-20 justify-center items-center md:items-start text-center md:text-left">
                    ...
                    <Fade direction="left" delay={300}>
                        <div className=" text-neutral-50 text-base font-normal mb-">
                            Homeverse.io is a gated community with a great
                            location. Located downtown, you’re within walking
                            distance of Parks, and the best shopping, dining and
                            entertainment Getting around is a breeze, with easy
                            access to freeways, buses and trolleys. . Laundry is
